  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: auto;">
        <div style="background-color: #291571; padding: 20px; border-radius: 5px; text-align: center;">
        ...
        <div style="padding: 20px; background-color: white; border-radius: 5px;">
          ...
          <p style="margin: 20px 0;">
            <a href="${URL}" 
               style="background-color: #291571; color: white; padding: 12px 20px; text-decoration: none; border-radius: 5px; display: inline-block;">
               Start Your Journey
            </a>
          </p>
...
export const inactiveInvites = (req, res) => {
  ...
  db.query(getCompanyEmailQuery, [company_id], (err, result) => {
    ...
    const Inactivemail = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; color: white; background-color: #291571; padding: 20px; border-radius: 8px; max-width: 600px; margin: 0 auto;">
