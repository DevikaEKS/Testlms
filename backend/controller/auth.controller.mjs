    ...
    db.query(
      ...
      async (err, existingCompanies) => {
        ...
        db.beginTransaction((err) => {
          ...
          (company_name, company_email_id, country, zipcode, company_phone_number, spoc_name, spoc_email_id, spoc_phone_number, company_size, company_type, password, state, city)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`;
      ...
      db.query(
        ...
        (err, authRows) => {
          ...
          bcrypt.hash(password, saltRounds, (err, hashedPassword) => {
            ...
            // Insert into User table
            db.query(
              "INSERT INTO user (first_name, email, phone_no, password, qualification, profession, has_paid,profile_image, country, state, city) VALUES (?, ?, ?, ?,?,?,?,?,?,?,?)",
              [
                fullname,
                email,
                phone_no,
...
export const forgotPassword = (req, res) => {
  ...
  db.query(query, [email], (error, results) => {
    ...
    const mailOptions = {
      ...
      html: `
        <html>
          <body style="font-family: Arial, sans-serif; background-color: #291571; color: #ffffff; margin: 0; padding: 0;">
            <table width="100%" bgcolor="#291571" cellpadding="0" cellspacing="0" style="padding: 20px;">
              <tr>
                <td align="center">
                  <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden;">
                    <tr>
                      <td style="background-color: #291571; padding: 20px; text-align: center;">
                        <h1 style="color: #ffffff; margin: 0;">Dr. Ken Spine Coach</h1>
                      </td>
                    </tr>
                    <tr>
                      <td style="padding: 20px; color: #333333;">
                        <h2 style="font-size: 24px; color: #291571; margin-bottom: 10px;">Reset Your Password</h2>
                        ...
                        <div style="text-align: center; margin: 20px 0;">
                          <a href="${resetLink}" style="background-color: #291571; color: #ffffff; padding: 10px 20px; border-radius: 5px; text-decoration: none; font-size: 16px;">
                            Reset Password
                          </a>
                        </div>
                        <p style="font-size: 16px; line-height: 1.5;">
                    ...
                    <tr>
                      <td style="background-color: #291571; padding: 10px; text-align: center; color: #ffffff;">
